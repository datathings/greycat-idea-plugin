...
public class GreyCatFoldingBuilder implements FoldingBuilder {
    private static final TokenSet CURLY_FOLDABLES = TokenSet.create(TYPE_DECL, FN_DECL, ENUM_DECL, TYPE_METHOD, BLOCK);
    private static final TokenSet SQUARE_FOLDABLES = TokenSet.create(ARRAY_EXPR);
