...
public class GreyCatThreeFieldsObjImpl extends ASTWrapperPsiElement implements GreyCatThreeFieldsObj {

  public GreyCatThreeFieldsObjImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GreyCatVisitor visitor) {
    visitor.visitThreeFieldsObj(this);
  }
