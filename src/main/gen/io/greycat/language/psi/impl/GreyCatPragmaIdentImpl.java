...
public class GreyCatPragmaIdentImpl extends ASTWrapperPsiElement implements GreyCatPragmaIdent {

  public GreyCatPragmaIdentImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GreyCatVisitor visitor) {
    visitor.visitPragmaIdent(this);
  }
