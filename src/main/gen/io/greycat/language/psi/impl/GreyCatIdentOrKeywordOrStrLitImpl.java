...
public class GreyCatIdentOrKeywordOrStrLitImpl extends ASTWrapperPsiElement implements GreyCatIdentOrKeywordOrStrLit {

  public GreyCatIdentOrKeywordOrStrLitImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GreyCatVisitor visitor) {
    visitor.visitIdentOrKeywordOrStrLit(this);
  }
