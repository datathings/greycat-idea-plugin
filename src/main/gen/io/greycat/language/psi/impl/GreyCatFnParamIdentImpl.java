...
public class GreyCatFnParamIdentImpl extends ASTWrapperPsiElement implements GreyCatFnParamIdent {

  public GreyCatFnParamIdentImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GreyCatVisitor visitor) {
    visitor.visitFnParamIdent(this);
  }
