...
public class GreyCatNumAppendixImpl extends ASTWrapperPsiElement implements GreyCatNumAppendix {

  public GreyCatNumAppendixImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GreyCatVisitor visitor) {
    visitor.visitNumAppendix(this);
  }
