...
public class GreyCatAttrIdentImpl extends ASTWrapperPsiElement implements GreyCatAttrIdent {

  public GreyCatAttrIdentImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GreyCatVisitor visitor) {
    visitor.visitAttrIdent(this);
  }
