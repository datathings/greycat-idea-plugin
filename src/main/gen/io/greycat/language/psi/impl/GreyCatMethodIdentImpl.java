...
public class GreyCatMethodIdentImpl extends ASTWrapperPsiElement implements GreyCatMethodIdent {

  public GreyCatMethodIdentImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GreyCatVisitor visitor) {
    visitor.visitMethodIdent(this);
  }
