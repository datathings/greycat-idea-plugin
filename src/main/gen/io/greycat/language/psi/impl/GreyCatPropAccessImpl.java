...
public class GreyCatPropAccessImpl extends ASTWrapperPsiElement implements GreyCatPropAccess {

  public GreyCatPropAccessImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GreyCatVisitor visitor) {
    visitor.visitPropAccess(this);
  }
