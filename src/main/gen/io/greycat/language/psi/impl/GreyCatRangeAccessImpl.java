...
public class GreyCatRangeAccessImpl extends ASTWrapperPsiElement implements GreyCatRangeAccess {

  public GreyCatRangeAccessImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GreyCatVisitor visitor) {
    visitor.visitRangeAccess(this);
  }
