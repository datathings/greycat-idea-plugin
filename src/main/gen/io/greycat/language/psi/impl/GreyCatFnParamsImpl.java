...
public class GreyCatFnParamsImpl extends ASTWrapperPsiElement implements GreyCatFnParams {

  public GreyCatFnParamsImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<GreyCatFnParam> getFnParamList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, GreyCatFnParam.class);
  }
