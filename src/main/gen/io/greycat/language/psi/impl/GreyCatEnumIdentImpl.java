...
public class GreyCatEnumIdentImpl extends ASTWrapperPsiElement implements GreyCatEnumIdent {

  public GreyCatEnumIdentImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GreyCatVisitor visitor) {
    visitor.visitEnumIdent(this);
  }
