...
public class GreyCatFnOrTaskImpl extends ASTWrapperPsiElement implements GreyCatFnOrTask {

  public GreyCatFnOrTaskImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GreyCatVisitor visitor) {
    visitor.visitFnOrTask(this);
  }
