...
public class GreyCatForInParamImpl extends ASTWrapperPsiElement implements GreyCatForInParam {

  public GreyCatForInParamImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GreyCatVisitor visitor) {
    visitor.visitForInParam(this);
  }
  ...
  @Override
  @Nullable
  public GreyCatFnParam getFnParam() {
