...
public class GreyCatTableExprImpl extends ASTWrapperPsiElement implements GreyCatTableExpr {

  public GreyCatTableExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public GreyCatTableExprRows getTableExprRows() {
    return findChildByClass(GreyCatTableExprRows.class);
  }
