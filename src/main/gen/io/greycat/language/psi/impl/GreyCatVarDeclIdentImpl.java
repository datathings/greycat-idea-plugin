...
public class GreyCatVarDeclIdentImpl extends ASTWrapperPsiElement implements GreyCatVarDeclIdent {

  public GreyCatVarDeclIdentImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GreyCatVisitor visitor) {
    visitor.visitVarDeclIdent(this);
  }
