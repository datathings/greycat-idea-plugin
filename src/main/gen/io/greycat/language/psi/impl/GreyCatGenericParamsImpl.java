...
public class GreyCatGenericParamsImpl extends ASTWrapperPsiElement implements GreyCatGenericParams {

  public GreyCatGenericParamsImpl(@NotNull ASTNode node) {
    super(node);
  }
