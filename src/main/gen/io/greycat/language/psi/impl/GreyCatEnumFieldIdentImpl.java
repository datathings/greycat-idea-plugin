...
public class GreyCatEnumFieldIdentImpl extends ASTWrapperPsiElement implements GreyCatEnumFieldIdent {

  public GreyCatEnumFieldIdentImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GreyCatVisitor visitor) {
    visitor.visitEnumFieldIdent(this);
  }
