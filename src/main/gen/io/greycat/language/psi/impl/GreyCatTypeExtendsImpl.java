...
public class GreyCatTypeExtendsImpl extends ASTWrapperPsiElement implements GreyCatTypeExtends {

  public GreyCatTypeExtendsImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public GreyCatTypeSpecifier getTypeSpecifier() {
    return findNotNullChildByClass(GreyCatTypeSpecifier.class);
  }
