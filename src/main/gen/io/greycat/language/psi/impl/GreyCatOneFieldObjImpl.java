...
public class GreyCatOneFieldObjImpl extends ASTWrapperPsiElement implements GreyCatOneFieldObj {

  public GreyCatOneFieldObjImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GreyCatVisitor visitor) {
    visitor.visitOneFieldObj(this);
  }
  ...
  public GreyCatExpression getExpression() {
    return findChildByClass(GreyCatExpression.class);
  }
