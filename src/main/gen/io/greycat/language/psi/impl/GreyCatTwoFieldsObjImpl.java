...
public class GreyCatTwoFieldsObjImpl extends ASTWrapperPsiElement implements GreyCatTwoFieldsObj {

  public GreyCatTwoFieldsObjImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GreyCatVisitor visitor) {
    visitor.visitTwoFieldsObj(this);
  }
