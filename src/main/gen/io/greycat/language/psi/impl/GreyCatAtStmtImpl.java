...
public class GreyCatAtStmtImpl extends ASTWrapperPsiElement implements GreyCatAtStmt {

  public GreyCatAtStmtImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GreyCatVisitor visitor) {
    visitor.visitAtStmt(this);
  }
