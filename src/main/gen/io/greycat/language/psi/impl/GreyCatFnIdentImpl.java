...
public class GreyCatFnIdentImpl extends ASTWrapperPsiElement implements GreyCatFnIdent {

  public GreyCatFnIdentImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GreyCatVisitor visitor) {
    visitor.visitFnIdent(this);
  }
