...
public class GreyCatShortArrayExprImpl extends ASTWrapperPsiElement implements GreyCatShortArrayExpr {

  public GreyCatShortArrayExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GreyCatVisitor visitor) {
    visitor.visitShortArrayExpr(this);
  }
