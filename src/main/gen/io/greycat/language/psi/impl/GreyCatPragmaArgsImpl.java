...
public class GreyCatPragmaArgsImpl extends ASTWrapperPsiElement implements GreyCatPragmaArgs {

  public GreyCatPragmaArgsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GreyCatVisitor visitor) {
    visitor.visitPragmaArgs(this);
  }
