...
public class GreyCatFnParamImpl extends ASTWrapperPsiElement implements GreyCatFnParam {

  public GreyCatFnParamImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public GreyCatFnParamIdent getFnParamIdent() {
    return findNotNullChildByClass(GreyCatFnParamIdent.class);
  }
