...
public class GreyCatPrefixExprImpl extends ASTWrapperPsiElement implements GreyCatPrefixExpr {

  public GreyCatPrefixExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public GreyCatCallExpr getCallExpr() {
    return findNotNullChildByClass(GreyCatCallExpr.class);
  }
