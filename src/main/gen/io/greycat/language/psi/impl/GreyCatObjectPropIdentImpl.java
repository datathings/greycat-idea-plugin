...
public class GreyCatObjectPropIdentImpl extends ASTWrapperPsiElement implements GreyCatObjectPropIdent {

  public GreyCatObjectPropIdentImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GreyCatVisitor visitor) {
    visitor.visitObjectPropIdent(this);
  }
