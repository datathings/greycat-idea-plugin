...
public class GreyCatPragmaStmtImpl extends ASTWrapperPsiElement implements GreyCatPragmaStmt {

  public GreyCatPragmaStmtImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public GreyCatPragma getPragma() {
    return findNotNullChildByClass(GreyCatPragma.class);
  }
