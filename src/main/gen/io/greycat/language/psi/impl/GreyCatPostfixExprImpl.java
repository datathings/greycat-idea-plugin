...
public class GreyCatPostfixExprImpl extends ASTWrapperPsiElement implements GreyCatPostfixExpr {

  public GreyCatPostfixExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public GreyCatPrefixExpr getPrefixExpr() {
    return findNotNullChildByClass(GreyCatPrefixExpr.class);
  }
