...
public class GreyCatCatchStmtImpl extends ASTWrapperPsiElement implements GreyCatCatchStmt {

  public GreyCatCatchStmtImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GreyCatVisitor visitor) {
    visitor.visitCatchStmt(this);
  }
