...
public class GreyCatTryStmtImpl extends ASTWrapperPsiElement implements GreyCatTryStmt {

  public GreyCatTryStmtImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public GreyCatCatchStmt getCatchStmt() {
    return findNotNullChildByClass(GreyCatCatchStmt.class);
  }
