...
public class GreyCatObjectExprImpl extends ASTWrapperPsiElement implements GreyCatObjectExpr {

  public GreyCatObjectExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public GreyCatObjectProps getObjectProps() {
    return findChildByClass(GreyCatObjectProps.class);
  }

  @Override
  @Nullable
  public GreyCatTypeIdent getTypeIdent() {
    return findChildByClass(GreyCatTypeIdent.class);
  }
