...
public class GreyCatEnumFieldImpl extends ASTWrapperPsiElement implements GreyCatEnumField {

  public GreyCatEnumFieldImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public GreyCatEnumFieldIdent getEnumFieldIdent() {
    return findNotNullChildByClass(GreyCatEnumFieldIdent.class);
  }
