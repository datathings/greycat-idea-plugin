...
public class GreyCatStaticPropIdentImpl extends ASTWrapperPsiElement implements GreyCatStaticPropIdent {

  public GreyCatStaticPropIdentImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GreyCatVisitor visitor) {
    visitor.visitStaticPropIdent(this);
  }
