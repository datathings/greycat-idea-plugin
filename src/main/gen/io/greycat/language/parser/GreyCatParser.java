...
public class GreyCatParser implements PsiParser, LightPsiParser {
  ...
  public static boolean NumLit(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "NumLit")) return false;
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, NUM_LIT, "<num lit>");
    r = NumLit_0(b, l + 1);
    r = r && NumLit_1(b, l + 1);
    exit_section_(b, l, m, r, false, null);
    return r;
  ...
  // (PLUS|MINUS)?
  private static boolean NumLit_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "NumLit_0")) return false;
    NumLit_0_0(b, l + 1);
    return true;
  }

  // PLUS|MINUS
  private static boolean NumLit_0_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "NumLit_0_0")) return false;
    boolean r;
  ...
  // (NUMBER NumAppendix?)+
  private static boolean NumLit_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "NumLit_1")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = NumLit_1_0(b, l + 1);
    while (r) {
      int c = current_position_(b);
      if (!NumLit_1_0(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "NumLit_1", c)) break;
    }
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  // NUMBER NumAppendix?
  private static boolean NumLit_1_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "NumLit_1_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, NUMBER);
    r = r && NumLit_1_0_1(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // NumAppendix?
  private static boolean NumLit_1_0_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "NumLit_1_0_1")) return false;
    NumAppendix(b, l + 1);
    return true;
  }
